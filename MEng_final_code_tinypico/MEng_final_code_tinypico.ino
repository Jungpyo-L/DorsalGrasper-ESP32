...
// Define pins ------------------------------------------
// Botton row:
#define MOTOR_A 32    // Motor output A (A0 in ESP32)
#define MOTOR_B 33    // Motor output B (A1 in ESP32)
#define BTN_G 34      // Button green input (A2 in ESP32)
#define BTN_R 39      // Button red input (A3 in ESP32)
#define CALIBRATION_BUTTON 15 // Joystick left input (A4 in ESP32)
#define JOYSTICK_BUTTON 27  // Joystick right input (A5 in ESP32)
...
#define LED_G 26    // LED green output (actual pin 15)
#define LED_R 25    // LED red output
...
void loop()
{
  ...
  //     // Serial.println("hi");
  //   }
  //   if (digitalRead(WRIST_MODE_BUTTON) == HIGH)
  //   {
  //     state = WRIST_MODE;
  //     timerWrite(timer0, 0);
  //     timerStart(timer0);
...
//   int buttonState = digitalRead(CALIBRATION_BUTTON);
